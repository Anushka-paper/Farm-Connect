          ...
          <Modal.Body>
            ...
            <View className="divide-y">
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">In-stock items only</Text>
                <Switch
              ...
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Discounted items only</Text>
                <Switch
              ...
              <View className="py-4">
                <Text className="font-medium text-gray-700">Price Range</Text>
