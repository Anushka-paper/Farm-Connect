...
// Main function for the Cart Screen
        ...
        {cartItems.length === 0 ? (
          <>
            <View className="h-full space-y-3 bg-white">
              <View className="py-20">
                ...
                <Text className="text-base font-bold text-center">Your cart is empty!</Text>
              </View>
            </View>
          </>
        ) : (
          <>
              ...
              <View className="py-4 mb-20 space-y-3">
                ...
                <View className="h-fit">
                  <View className="flex flex-row justify-between px-4">
                    <View>
                      <Text className="mb-2 text-sm font-bold">Your Cart</Text>
                    </View>
            ...
            <View className="fixed bottom-0 left-0 right-0 z-10 flex flex-row items-center justify-between px-3 py-3 bg-white border-t border-gray-300 shadow-3xl lg:hidden">
              <View>
                <Text className="font-light">Total Cart</Text>
